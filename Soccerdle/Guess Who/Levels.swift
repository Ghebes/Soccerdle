...
class LevelInformation : ObservableObject{
    ...
    @Published var levels: [Level] = [
        ...
        Level(number: 12, playerName: "Lionel Mesis", lastName:"Messi"),
        ...
        Level(number: 30, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 31, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 32, playerName: "Lionel Mesis", lastName:"Messi"),
        Level(number: 33, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 34, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 35, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 36, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 37, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 38, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 39, playerName: "Lionel Messi", lastName:"Messi"),
        Level(number: 40, playerName: "Lionel Messi", lastName:"Messi"),
    ]
}
